...
$csvFile = __DIR__ . '/ml/data_for_training.csv'; // Путь к файлу, куда будем записывать данные
...
try {
    ...
    // Запрос для получения данных из таблицы sensors_history
    $stmt = $pdo->query("
        SELECT building_id, entrance_number, floor, sensor_type, sensor_data, normal_min, normal_max, status
        FROM sensor_history
